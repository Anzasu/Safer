          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: "Current Number Of Police: " + police.number),
              maxLength: 10,
              maxLines: 1,
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10)),
                  hintStyle: TextStyle(color: textOnLight, fontSize: 19.0),
                  hintText: "Current Number Of Firedepartment: " + fire.number),
              maxLength: 10,
              maxLines: 1,
              cursorColor: Colors.white,
            ),
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10)),
                  hintStyle: TextStyle(color: textOnLight, fontSize: 19.0),
                  hintText: "Current Number Of Ambulance: " + ambulance.number),
              maxLength: 10,
              maxLines: 1,
              cursorColor: Colors.white,
            ),
